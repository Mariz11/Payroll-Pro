...
function DeleteSidebar({
  ...
  const useSidebarCompaniesHookFunction = useSidebarCompaniesHook();
  ...
  const handleDelete = async () => {
    ...
    try {
      const del = await axios.delete('/api/companies', {
        data: { companyDetails: rowData },
      ...
      if (del) {
        ...
        useSidebarCompaniesHookFunction.refetch();
      }
    } catch (error: any) {
